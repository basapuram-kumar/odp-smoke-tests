#!/usr/bin/env bash
#
# Spark 3.3.3 (ODP layout spark3_3_3_3-client): kinit spark/<FQDN>, then SparkPi on YARN.
...
#   SPARK_KEYTAB, SPARK_PRINCIPAL_HOST, SPARK3_CLIENT_HOME (default .../spark3_3_3_3-client)
